...
export function Auditions() {
    return (
        <section id="auditions">
            ...
            <h4 className="text-3xl text-naranja mb-10">¿Quiénes pueden postular?</h4>
            ...
            <h4 className="text-3xl text-naranja mb-10">Requisitos clave</h4>
            <Text text={
            ...
            <h4 className="text-3xl text-naranja mb-10">No pueden participar</h4>
            <Text text={
                <ul className='list-disc list-inside'>
            ...
            <h4 className="text-3xl text-naranja mb-10">¿Cómo postular?</h4>
            <Text text={
